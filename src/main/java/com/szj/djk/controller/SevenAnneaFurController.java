...
@Component
@RestController
@RequestMapping("/anneaf7")
public class SevenAnneaFurController {
    @Autowired
    SevenAnneaFurService sevenAnneaFurService;
    @Autowired
...
//            System.out.println("新的数据"+ newlist);
        ...
        newlist.forEach(i->{
            if(i.getCoolWaterUpLimit()>valueRange.getShangDD()){
                ...
                warnTable.setRollingDeviceNumber("退火炉7#");
...
//            }
    ...
    public R<List<WarnTable>> listSpecial(SevenAnneaFur sevenAnneaFur, String rollingName)  {
//        System.out.println("触发了+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
        int amount = 10000;
        LocalDateTime ts = sevenAnneaFur.getTs();
        ...
        List<WarnTable> specialList = sevenAnneaFurService.selectSpecial(before,after,rollingName);
