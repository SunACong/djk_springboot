...
public class LmdpColdFurnaceRecord implements Serializable {
     ...
     * 装炉位置#二号位
     */
    private String furnacePosition2;

    /**
     * 装炉位置#三号位
     */
    private String furnacePosition3;

    /**
     * 装炉位置#四号位
     */
    private String furnacePosition4;
     ...
     * 装炉位置#三号位#冷轧卷号
     */
    private String batchNum3;

    /**
     * 装炉位置#四号位#冷轧卷号
     */
    private String batchNum4;
     ...
     * 装炉班次
     */
    private String chargeShift;

    /**
     * 出炉班次
     */
    private String dischargeShift;
