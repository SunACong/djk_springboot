...
* @description 针对表【five_castroll】的数据库操作Service实现
* @createDate 2023-03-04 16:59:58
*/
@Service
public class FiveCastrollServiceImpl extends ServiceImpl<FiveCastrollMapper, FiveCastroll> implements FiveCastrollService{
    @Autowired
    private FiveCastrollMapper fiveCastrollMapper;
    @Override
    public List<FiveCastroll> selectRollingNewData() {
        return fiveCastrollMapper.selectRollingNewData();
    }
