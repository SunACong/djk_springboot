...
import com.szj.djk.mapper.TwoAnneaFurMapper;
import com.szj.djk.service.ThreeAnneaFurService;
import com.szj.djk.mapper.ThreeAnneaFurMapper;
...
/**
* @author JIAJIA
* @description 针对表【three_annea_fur】的数据库操作Service实现
* @createDate 2023-03-23 17:16:01
*/
@Service
public class ThreeAnneaFurServiceImpl extends ServiceImpl<ThreeAnneaFurMapper, ThreeAnneaFur>
    implements ThreeAnneaFurService{
    @Autowired
    private ThreeAnneaFurMapper threeAnneaFurMapper;

    @Override
    public List<WarnTable> selectSpecial(LocalDateTime before, LocalDateTime after, String rollingName) {
        List<ThreeAnneaFur> threeAnneaFurs = threeAnneaFurMapper.selectSpecial(before,after);
        ArrayList<WarnTable> warnTables = new ArrayList<>();
        threeAnneaFurs.forEach(i ->{
